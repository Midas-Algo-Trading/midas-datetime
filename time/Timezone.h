...
static Timezone get_timezone_from_str(std::string_view timezone_string)
{
        if (timezone_string == "Coordinated Universl Time")
                return UTC;
...
static Timezone get_local_timezone()
{
        ...
        return get_timezone_from_str(timezone_name);
}
